...
namespace Stock
{
    ...
    public class Header
    {
        ...
        public static readonly List<string> Order_header = new List<string>() { "代號", "名稱", "價位", "張數", "總價" };

    }

    public enum HeaderType
    {
        日期, 市櫃, 代號, 名稱, 收盤價, 周轉率, 隔開盤價, 隔最高價, 隔最低價, 隔收盤價, 成交金額, 狀態, 獲利, 平均,
        排行, 前開, 前最高, 前最低, 前收, 前成交金額, 漲停, 前高數量, 前高距離, 三大法人
    }
